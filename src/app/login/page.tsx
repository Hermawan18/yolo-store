...
export default function Login() {
  return (
    <div>
      <div className="mt-10">
        <svg className="m-auto" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 90 40" width="200" height="100" role="img" aria-label="ユニクロ｜UNIQLO">
      ...
      <div className="bg-slate-300 rounded-md" style={{ margin: '0 144px' }}>
        <div className="flex mt-10 py-7 px-5">
